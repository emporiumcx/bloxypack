                    ...
                    >
                      ...
                      >
                        {isMine ? (
                          ...
                          <img alt="" className="h-[58%] w-[58%] object-contain" src="/img/lion_dark.png" />
                        )}
                      </div>
                    </button>
                  );
        ...
        <div className="flex items-center justify-between rounded-8 border border-grey-58 bg-grey-39 px-12 py-8">
          ...
          <div className="flex items-center gap-6">
            <button
              ...
              onClick={() => setDrag((v) => !v)}
              className={`flex h-32 w-32 items-center justify-center rounded-6 ${
                drag ? "bg-gradient-to-b from-green to-green-2 text-white" : "text-icons-secondary hover:bg-grey-47 hover:text-white"
              }`}
            >
              <DragIcon />
            </button>
